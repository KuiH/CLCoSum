WORKDIR="/home/xxx/CLCoSum/CLCoSum4GraphCodeBERT"
...
# only for test
# OUTPUT_DIR=/home/xxx/CLCoSum/CLCoSum4GraphCodeBERT/saved_models/summarize/pcsd_clean_repchar/from_pcsd_clean+delchar+tofunc_tokenlen_411
...
if [[ $MODEL_TAG == graphcodebert ]]; then
  MODEL_TYPE=roberta
...
CUDA_VISIBLE_DEVICES=${GPU} \
  ...
  --model_type $MODEL_TYPE --model_name_or_path $MODEL_PATH --tokenizer_name $TOKENIZER --config_name $MODEL_PATH \
...
CUDA_VISIBLE_DEVICES=${GPU} \
  ...
  --output_dir $OUTPUT_DIR --max_source_length 512 --max_target_length 64 \

...
def add_args(parser):
    ...
    parser.add_argument("--model_type", default="codet5", type=str, choices=['roberta', 'codet5'])
    ...
    parser.add_argument("--rouge_path", default="/home/cike/hhk/evaluate/metrics/rouge", type=str,
                        help="Path to rouge metric")
    parser.add_argument("--meteor_path", default="/home/cike/hhk/evaluate/metrics/meteor", type=str,
                        help="Path to meteor metric")

    ## Curriculum learning parameters
    parser.add_argument("--scheduler_fun", default="", type=str)
    parser.add_argument("--first_epoch_num", type=int, help='number used in first epoch')
